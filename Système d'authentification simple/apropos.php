...
<main class="container">
    <div class="row">
        <div class="col-md-8">
            <h1 class="mb-3">A propos de mon projet</h1>
            <p>Page de mon mini projet PHP avec Bootstrap.</p>
            ...
            <?php else: ?>
                <div class="alert alert-info">
                    Tu n’es pas connecté. Utilise les liens « Inscription » ou « Connexion » dans le menu.
                </div>
            <?php endif; ?>
        </div>
